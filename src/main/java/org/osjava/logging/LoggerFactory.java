...
public final class LoggerFactory {
	...
	static {
		...
		try {
			...
			cname = "org.osjava.logging.Slf4JLoggerFactoryDelegate";
		} catch (Throwable ex) {
		...
		if(cname==null){
			try {
				...
				cname = "org.osjava.logging.Log4j2LoggerFactoryDelegate";
			} catch (Throwable ex) {
		...
		if(cname==null){
			try {
				...
				cname = "org.osjava.logging.Log4JLoggerFactoryDelegate";
			} catch (Throwable ex) {
